...
const LatestCode: React.FC<ILatestCode> = ({ repositories }) => {
  const [repos, setRepos] = useState<IRepo[]>([
    { name: '', description: '', clone_url: '' },
  ]);
...
const GithubRepoCard: React.FC<IGithubRepoCard> = ({ latestRepo }) => {
  return (
